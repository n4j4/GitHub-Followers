...
//  GitHub Followers
//
//  Created by Dmitry Smirnov on 27.07.2021.
//
    ...
    func addUserToFavorites(user: User) {
        ...
        PersistenceManager.updateWith(favorite: favorite, actionType: .add) { [weak self] error in
            ...
            guard let error = error else {
                self.presentGFAlertOnMainThread(title: "Success!", message: "You have successfully added this user to favorites 🎉.", buttonTitle: "Ok")
